		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto Browse Orders",
									"targetURL": "#comlab2devprojetobrowseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devprojetobrowseorders-display": {
								"semanticObject": "comlab2devprojetobrowseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.projetobrowseorders",
									"url": sap.ui.require.toUrl("com/lab2dev/projetobrowseorders")
								}
							}
						}
					}
